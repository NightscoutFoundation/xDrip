...
public class BgGraphBuilder {
    ...
    BgGraphBuilder(Context context, List<BgWatchData> aBgList, List<BgWatchData> aTreatsList, List<BgWatchData> aCalList, List<BgWatchData> aBtList, int aPointSize, int aMidColor, int timespan, boolean doMgdl) {
    ...
    public BgGraphBuilder(Context context, List<BgWatchData> aBgList, List<BgWatchData> aTreatsList, List<BgWatchData> aCalList, List<BgWatchData> aBtList, int aPointSize, int aHighColor, int aLowColor, int aMidColor, int timespan, boolean doMgdl) {
        end_time = new Date().getTime() + (1000 * 60 * 6 * timespan); //Now plus 30 minutes padding (for 5 hours. Less if less.)
        start_time = new Date().getTime()  - (1000 * 60 * 60 * timespan); //timespan hours ago
        this.bgDataList = aBgList;
        this.treatsDataList = aTreatsList;
