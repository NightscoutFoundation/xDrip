...
//KS import com.eveningoutpost.dexdrip.ErrorsActivity;
//KS import com.eveningoutpost.dexdrip.GcmActivity;
import com.eveningoutpost.dexdrip.Home;
import com.eveningoutpost.dexdrip.Models.JoH;
import com.eveningoutpost.dexdrip.Models.UserError;
import com.eveningoutpost.dexdrip.R;
//KS import com.eveningoutpost.dexdrip.UtilityModels.ShotStateStore;
import com.eveningoutpost.dexdrip.utils.PowerStateReceiver;
//KS import com.eveningoutpost.dexdrip.utils.WebAppHelper;
...
public class ActivityRecognizedService extends IntentService implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private static void disableMotionTrackingDueToErrors(Context context) {
        ...
        /*//KS Intent intent = new Intent(xdrip.getAppContext(), ErrorsActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent pendingIntent = PendingIntent.getActivity(xdrip.getAppContext(), 0, intent,
    ...
    private static void evaluateRequestReceivedCounters(boolean disable,Context context) {
        ...
        /*//KS if (JoH.ratelimit("evalute-request-received", 86400) || (disable)) {
                ...
                if (((topActivity.getConfidence() > 89) || ((lastactivity != null) && (topActivity.getType() == lastactivity.getType()) && ((lastactivity.getConfidence() + topActivity.getConfidence()) > 150)))
                    ...
                    if (Home.getPreferencesBoolean("motion_tracking_enabled", false)) {
                        ...
                        if ((from_local) && Home.getPreferencesBoolean("motion_tracking_enabled", false) && (Home.getPreferencesBoolean("act_as_motion_master", false))) {
                            ...
                            //KS TODO GcmActivity.sendMotionUpdate(JoH.tsl(), activityState.getType());
                        }
    ...
    private static void startupInfo() {
        //KS TODO if (ShotStateStore.hasShot(Home.SHOWCASE_MOTION_DETECTION)) return;
        //KS TODO Home.startHomeWithExtra(xdrip.getAppContext(), Home.ACTIVITY_SHOWCASE_INFO, "");
    }
