...
public class CollectionServiceStarter {
    ...
    private void stopAll() {
        ...
        JoH.stopService(getCollectorServiceClass(ConnectFollow));
    }
    ...
    private void start(Context context, String collection_method) {
        ...
        if (isBTWixelOrLimiTTer(collection_method) || isDexbridgeWixel(collection_method)) {
            ...
            if (DexCollectionType.hasBluetooth() || DexCollectionType.getDexCollectionType() == NSFollow || DexCollectionType.getDexCollectionType() == SHFollow || DexCollectionType.getDexCollectionType() == ConnectFollow) {
