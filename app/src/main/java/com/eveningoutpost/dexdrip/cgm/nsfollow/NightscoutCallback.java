 ...
 * When a {@code populator} is provided, it is called with the response body instead of
 * {@link Session#populate(Object)}, enabling typed population for non-Entry responses.
 */
