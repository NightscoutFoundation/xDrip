...
public class Preferences extends BasePreferenceActivity implements SearchPreferenceResultListener {
    ...
    protected void onResume()
    {
        ...
        PreferenceManager.getDefaultSharedPreferences(this).registerOnSharedPreferenceChangeListener(WatchBroadcastService.prefListener);
    ...
    protected void onPause()
    {
        ...
        PreferenceManager.getDefaultSharedPreferences(this).unregisterOnSharedPreferenceChangeListener(WatchBroadcastService.prefListener);
