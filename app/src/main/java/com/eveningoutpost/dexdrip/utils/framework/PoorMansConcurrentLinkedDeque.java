...
// TODO when API min level changes to 21 or greater we can update this to use native android version!!
/*
 ...
 */
public class PoorMansConcurrentLinkedDeque<E>
     ...
     */
    public PoorMansConcurrentLinkedDeque() {
     ...
     */
    public PoorMansConcurrentLinkedDeque(Collection<? extends E> c) {
        this();
        addAll(c);
    }
