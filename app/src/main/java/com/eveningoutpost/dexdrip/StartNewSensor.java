...
public class StartNewSensor extends ActivityWithMenu {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && DexCollectionType.hasBluetooth()) {
                    if (!LocationHelper.locationPermission(StartNewSensor.this)) {
                        JoH.show_ok_dialog(activity, xdrip.gs(R.string.please_allow_permission), xdrip.gs(R.string.location_permission_needed_to_use_bluetooth), new Runnable() {
                            @Override
                            public void run() {
    ...
    private void sensorButtonClick() {
        ...
        builder.setPositiveButton(xdrip.gs(R.string.yes_today), new DialogInterface.OnClickListener() {
    ...
    private void realRealStartSensor() {
        ...
        if (new Date().getTime() + 15 * 60000 < startTime) {
            Toast.makeText(this, xdrip.gs(R.string.error_sensor_start_time_in_future), Toast.LENGTH_LONG).show();
            return;
        }
    ...
    /*public void oldaddListenerOnButton() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
          public void onClick(View v) {
              ...
              Toast.makeText(getApplicationContext(), xdrip.gs(R.string.new_sensor_started), Toast.LENGTH_LONG).show();
