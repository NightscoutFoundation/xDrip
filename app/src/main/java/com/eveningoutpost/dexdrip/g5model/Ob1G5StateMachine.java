...
public class Ob1G5StateMachine {
    ...
    public static boolean doGetData(Ob1G5CollectionService parent, RxBleConnection connection) {
        ...
        UserError.Log.d(TAG, use_g5_internal_alg ? ("Requesting Glucose Data " + (usingG6() ? (FirmwareCapability.isDeviceG7(getTransmitterID()) ? "G7" : "G6") : "G5")) : "Requesting Sensor Data");
