...
public class Libre2RawValue extends PlusModel {
    ...
    public static void updateDB() {
		...
		// -- JPBOU -------------------------------------------
		// As Libre2RawValue was not synchronized with 
		// followers there was no need to convert it to JSON.
		// This has been added to allow serializing of
		// Libre2RawValue.
    public String toJSON() {
		...
		// Added to allow deserialization of Libre2RawValue
		// when synchronizing from master to followers.
...
// -- JPBOU -----------------------------------------------
// I'm not sure why this class is here. It seems to not be
// present on current xDrip master. I don't know if I added
// it or it was present on a previous version.
// I will leave it here to not break anything, although I
// can't find any use to it in any code.
