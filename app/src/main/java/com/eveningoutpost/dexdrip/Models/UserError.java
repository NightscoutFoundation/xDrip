...
public class UserError extends Model {
    ...
    public static List<UserError> bySeverity(int []levels) {
        String levelsString = "";
        ...
        return new Select()
                .from(UserError.class)
                .where("severity in ["+levelsString.substring(0,levelsString.length() - 2)+"]")
                .orderBy("timestamp desc")
                .execute();
    }
    ...
    public static List<UserError> bySeverity(int level, int level2) {
        return bySeverity(new int[]{ level, level2 });
    }
    public static List<UserError> bySeverity(int level, int level2, int level3) {
        return bySeverity(new int[]{ level, level2, level3 });
    }
