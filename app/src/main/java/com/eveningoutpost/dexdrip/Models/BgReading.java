    ...
    */
            ...
            if (bgReading.Unclear()) {
                ...
                if (LastGoodTime == 0l) {
                    ...
                    if(LastGoodTime - bgReading.timestamp >= MAX_INFLUANCE) {
                        Log.d(TAG_ALERT, "We have a good period from " + bgReading.timestamp + " to " + LastGoodTime + "returning " + (now - UnclearTime +60000));
    ...
    static void TestgetUnclearTime(String input, Long interstingTime, Long expectedResult) {
        ...
        if (result == expectedResult * 60000) {
            ...
            Log.d(TAG_ALERT, "Test failed expectedResult = " + expectedResult + " result = "+ result /5 / 60000);
        }
