...
/**
 * Behavioural tests for the special-message preferences the Pebble trend watchface receives.
 * <p>
 ...
 */
public class PebbleDisplayTrendPreferencesTest extends RobolectricTestWithConfig {

    private PebbleDisplayTrend display;
    ...
    public void setUp() {
        ...
        long end = JoH.tsl();
        display = new PebbleDisplayTrend();
    ...
    private String message() {
        ...
        return dictionary.getString(PebbleDisplayTrend.MESSAGE_KEY);
    }
